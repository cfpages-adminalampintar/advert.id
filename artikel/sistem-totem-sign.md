---
article_id: ADV-05-04
title: "Totem Sign sebagai Cabinet, Structure, dan Foundation"
slug: "sistem-totem-sign"
description: "Map face/cabinet, internal frame, pole/base, anchors/foundation, wind, lighting, access, vehicle/public interface and permits"
status: outline
publication_date: "2025-12-07"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ADV-05
primary_intent: "Understand freestanding sign coordination"
reader_community: "Advert.id"
reader_address: "Teman Advert.id"
final_route: "/artikel/sistem-totem-sign.html"
...
# Totem Sign sebagai Cabinet, Structure, dan Foundation

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Totem Sign sebagai Cabinet, Structure, dan Foundation”
- **Reader and situation:** Owner treating a totem as furniture
- **Reader outcome:** Map face/cabinet, internal frame, pole/base, anchors/foundation, wind, lighting, access, vehicle/public interface and permits
- **Primary intent:** Understand freestanding sign coordination
...
- **Scope boundary:** No height, footing or setback values; `/totem/` owns sale and ADV-09/11 design
- **Final public route:** `/artikel/sistem-totem-sign.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Totem Sign sebagai Cabinet, Structure, dan Foundation**.
...
- **Exact Markdown to insert:** `![Ilustrasi totem sign](/wp-content/uploads/2024/06/totem-sign.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `totem sign` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Totem Sign sebagai Cabinet, Structure, dan Foundation”.
