---
article_id: ADV-13-03
title: "Scope Matrix Creative, Fabrication, Structure, Electrical, Permit, dan Content"
slug: "scope-matrix-proyek-advertising"
description: "Assign survey/design, artwork, engineering, landlord/authority, tax, production, power/data, civil, installation, content, tests, operation, defects and removal"
status: outline
publication_date: "2026-06-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ADV-13
primary_intent: "Eliminate package gaps"
...
# Scope Matrix Creative, Fabrication, Structure, Electrical, Permit, dan Content

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Scope Matrix Creative, Fabrication, Structure, Electrical, Permit, dan Content”
- **Reader and situation:** Multi-party project splitting responsibilities
- **Reader outcome:** Assign survey/design, artwork, engineering, landlord/authority, tax, production, power/data, civil, installation, content, tests, operation, defects and removal
- **Primary intent:** Eliminate package gaps
...
- **Scope boundary:** Not a contract/legal allocation; parties must approve terms
- **Final public route:** `/artikel/scope-matrix-proyek-advertising.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Scope Matrix Creative, Fabrication, Structure, Electrical, Permit, dan Content**.
...
- **Tie back to this article:** Keep the explanation specific to “Scope Matrix Creative, Fabrication, Structure, Electrical, Permit, dan Content”.
