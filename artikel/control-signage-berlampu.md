...
title: "Timer, Sensor, Dimming, dan Remote Control Signage"
slug: "control-signage-berlampu"
description: "Define schedule, astronomical/time controls, sensors, dimming, manual override, fail state, logging, remote access, responsibilities and testing"
status: outline
...
# Timer, Sensor, Dimming, dan Remote Control Signage

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Timer, Sensor, Dimming, dan Remote Control Signage”
- **Reader and situation:** Owner reducing energy and managing schedules
- **Reader outcome:** Define schedule, astronomical/time controls, sensors, dimming, manual override, fail state, logging, remote access, responsibilities and testing
- **Primary intent:** Specify operational controls
...
- **Scope boundary:** No controller/vendor choice or cybersecurity approval; ADV-07-06 owns network security
- **Final public route:** `/artikel/control-signage-berlampu.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Timer, Sensor, Dimming, dan Remote Control Signage**.
...
- **Tie back to this article:** Keep the explanation specific to “Timer, Sensor, Dimming, dan Remote Control Signage”.
