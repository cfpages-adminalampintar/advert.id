...
description: "Identify windshield/windows, mirrors, lamps/reflectors, plates, cameras/sensors, emergency markings, door operation and authority questions"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Branding Kendaraan dan Area yang Tidak Boleh Mengganggu Keselamatan”
- **Reader and situation:** Designer placing graphics near glazing/lights/sensors
- **Reader outcome:** Identify windshield/windows, mirrors, lamps/reflectors, plates, cameras/sensors, emergency markings, door operation and authority questions
- **Primary intent:** Protect visibility and vehicle functions
...
- **Scope boundary:** No road-legal declaration; current vehicle/traffic authority and owner requirements govern
- **Final public route:** `/artikel/area-kritis-branding-kendaraan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Branding Kendaraan dan Area yang Tidak Boleh Mengganggu Keselamatan**.
...
- `ADV-08-03` → `/artikel/artwork-dan-seam-vehicle-wrap.html` — Artwork Template dan Seam Planning untuk Vehicle Wrap
...
- `ADV-08-06` → `/artikel/perawatan-dan-removal-vehicle-wrap.html` — Cleaning, Repair Patch, dan Removal Vehicle Wrap
...
- **Tie back to this article:** Keep the explanation specific to “Branding Kendaraan dan Area yang Tidak Boleh Mengganggu Keselamatan”.
