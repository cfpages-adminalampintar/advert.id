---
article_id: ADV-02-06
title: "Message Hierarchy untuk Media yang Dilihat Singkat"
slug: "message-hierarchy-media-outdoor"
description: "Prioritize brand, one promise/action, visual order, contrast, amount of information and context testing"
status: outline
publication_date: "2025-09-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ADV-02
primary_intent: "Simplify creative for brief exposure"
...
# Message Hierarchy untuk Media yang Dilihat Singkat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Message Hierarchy untuk Media yang Dilihat Singkat”
- **Reader and situation:** Designer/brand preparing outdoor copy
- **Reader outcome:** Prioritize brand, one promise/action, visual order, contrast, amount of information and context testing
- **Primary intent:** Simplify creative for brief exposure
...
- **Scope boundary:** No universal word count or letter size; ADV-03-03 owns legibility tests
- **Final public route:** `/artikel/message-hierarchy-media-outdoor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Message Hierarchy untuk Media yang Dilihat Singkat**.
...
- **Tie back to this article:** Keep the explanation specific to “Message Hierarchy untuk Media yang Dilihat Singkat”.
